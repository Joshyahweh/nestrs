...
[dependencies]
nestrs = "1.5.0"
nestrs-prisma = { version = "1.5.0", features = ["sqlx", "sqlx-postgres"] }
...
```toml
nestrs-prisma = { version = "1.5.0", features = ["sqlx", "sqlx-mysql"] }
```
...
```toml
nestrs-prisma = { version = "1.5.0", features = ["sqlx", "sqlx-sqlite"] }
...
**[`nestrs-prisma/examples/quickstart.rs`](../../nestrs-prisma/examples/quickstart.rs)** (also on GitHub: `nestrs-prisma/examples/quickstart.rs` on tag **`v1.5.0`**).
...
```toml
nestrs = { version = "1.5.0", features = ["graphql", "mongo"] }
mongodb = "3"
bson = "3"
async-graphql = "=7.0.17"
futures-util = { version = "0.3", features = ["sink"] }
...
```toml
nestrs = { version = "1.5.0", features = ["microservices", "microservices-grpc"] }
nestrs-prisma = { version = "1.5.0", features = ["sqlx", "sqlx-postgres"] }
async-trait = "0.1"
serde = { version = "1", features = ["derive"] }
serde_json = "1"
...
nestrs = { version = "1.5.0", features = ["microservices", "microservices-nats"] }

# Redis micro listener
nestrs = { version = "1.5.0", features = ["microservices", "microservices-redis"] }

# RabbitMQ work-queue listener
nestrs = { version = "1.5.0", features = ["microservices", "microservices-rabbitmq"] }

# Kafka transport (client) — enable kafka on nestrs-microservices transitively
nestrs = { version = "1.5.0", features = ["microservices", "microservices-kafka"] }
```
