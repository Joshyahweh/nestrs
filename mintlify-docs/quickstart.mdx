...
Run `nestrs-cli new` with your project name:
...
<Tip>
  Use `nestrs-cli new my-api --strict` to add `#![deny(unsafe_code)]` to the generated `src/main.rs`. Use `--no-git` to skip initialising a git repository.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="CLI reference" icon="terminal" href="/cli/overview">
    Generate controllers, services, guards, pipes, and more with `nestrs-cli generate`.
  </Card>
</CardGroup>
