# nestrs-cli-new-bare-1789613851945272000
...
```bash
docker build -t nestrs-cli-new-bare-1789613851945272000:latest .
docker run -p 3000:3000 --env NESTRS_ENV=production nestrs-cli-new-bare-1789613851945272000:latest
```
