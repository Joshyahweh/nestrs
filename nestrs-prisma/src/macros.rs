...
macro_rules! __prisma_insert_returning {
    (
        ...
        let mut qb = $crate::sqlx::QueryBuilder::<$crate::sqlx::Any>::new(concat!("INSERT INTO \"", $table, "\" ("));
...
///
/// Prisma `DateTime` fields generated by the schema bridge are mapped to `String` (ISO-8601 text) so models work
/// with `sqlx::Any`; you can still declare `chrono::DateTime<Utc>` manually if you use a concrete database driver.
///
...
macro_rules! prisma_model {
    (
        ...
        $crate::paste::paste! {
            ...
            impl [< $Model OrderBy >] {
                fn __push_order(&self, qb: &mut $crate::sqlx::QueryBuilder<'_, $crate::sqlx::Any>) {
                    match self {
                        $(
            ...
            impl [< Prisma $Model Repository >] for $crate::client::ModelRepository<$Model> {
                async fn find_unique(
                    ...
                    let pool = $crate::sqlx_pool().await?;
                    let mut qb = $crate::sqlx::QueryBuilder::<$crate::sqlx::Any>::new(concat!(
                        "SELECT * FROM \"",
                        $table,
                        "\" WHERE "
                    ));
                ...
                async fn update(
                    ...
                    let pool = $crate::sqlx_pool().await?;
                    let mut qb =
                        $crate::sqlx::QueryBuilder::<$crate::sqlx::Any>::new(concat!("UPDATE \"", $table, "\" SET "));
                ...
                async fn delete(&self, w: [< $Model Where >]) -> std::result::Result<$Model, $crate::PrismaError> {
                    let pool = $crate::sqlx_pool().await?;
                    let mut qb =
                        $crate::sqlx::QueryBuilder::<$crate::sqlx::Any>::new(concat!("DELETE FROM \"", $table, "\" WHERE "));
                    w.__push_where(&mut qb)?;
                    qb.push(" RETURNING *");
                    let row = qb
                        .build_query_as()
