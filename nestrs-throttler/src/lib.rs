...
#![doc(html_root_url = "https://docs.rs/nestrs-throttler/1.0.0")]
...
// `nestrs_throttler::ThrottlerGuard + nestrs_throttler::CanActivate` without
...
pub use backend::{InMemoryThrottler, RedisThrottler, ThrottlerBackend, ThrottlerBackendKind};
