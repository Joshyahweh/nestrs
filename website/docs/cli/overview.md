...
This page documents **Overview** in the **cli** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="cli" topic="overview" title="Overview" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs-cli overview
```
