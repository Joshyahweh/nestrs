...
This page documents **CLI Plugin** in the **graphql** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="graphql" topic="cli-plugin" title="CLI Plugin" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs-graphql cli_plugin
```
