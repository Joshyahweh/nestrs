...
This page documents **Interceptors** in the **introduction** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="introduction" topic="interceptors" title="Interceptors" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs interceptors
```
