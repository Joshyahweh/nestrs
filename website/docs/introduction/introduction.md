...
This page documents **Introduction** in the **introduction** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="introduction" topic="introduction" title="Introduction" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs introduction
```
