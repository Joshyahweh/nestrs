...
This page documents **Pipes** in the **introduction** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="introduction" topic="pipes" title="Pipes" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs pipes
```
