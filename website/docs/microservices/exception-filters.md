...
This page documents **Exception filters** in the **microservices** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="microservices" topic="exception-filters" title="Exception filters" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs-microservices exception_filters
```
