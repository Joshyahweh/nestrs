...
This page documents **Guards** in the **microservices** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="microservices" topic="guards" title="Guards" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs-microservices guards
```
