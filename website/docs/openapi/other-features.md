...
This page documents **Other features** in the **openapi** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="openapi" topic="other-features" title="Other features" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs-openapi other_features
```
