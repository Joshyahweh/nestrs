...
This page documents **Security** in the **openapi** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="openapi" topic="security" title="Security" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs-openapi security
```
