---
title: "CQRS"
description: "What this page covers: CQRS in nestrs, with section-specific practical examples."
---

## Why this matters

This page documents **CQRS** in the **recipes** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="recipes" topic="cqrs" title="CQRS" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs cqrs
```
