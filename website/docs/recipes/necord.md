---
title: "Necord"
description: "What this page covers: Necord in nestrs, with section-specific practical examples."
---

## Why this matters

This page documents **Necord** in the **recipes** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="recipes" topic="necord" title="Necord" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs necord
```
