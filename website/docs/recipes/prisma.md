---
title: "Prisma"
description: "What this page covers: Prisma in nestrs, with section-specific practical examples."
---

## Why this matters

This page documents **Prisma** in the **recipes** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="recipes" topic="prisma" title="Prisma" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs prisma
```
