---
title: "REPL"
description: "What this page covers: REPL in nestrs, with section-specific practical examples."
---

## Why this matters

This page documents **REPL** in the **recipes** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="recipes" topic="repl" title="REPL" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs repl
```
