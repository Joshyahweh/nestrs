---
title: "Mongo"
description: "What this page covers: Mongo in nestrs, with section-specific practical examples."
---

## Why this matters

This page documents **Mongo** in the **techniques** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="techniques" topic="mongo" title="Mongo" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs mongo
```
