...
This page documents **Exception filters** in the **websockets** section and shows how to apply the right abstraction for this domain.
...
<AutoCodeTabs section="websockets" topic="exception-filters" title="Exception filters" />

## CLI check

```sh filename="terminal"
$ cargo test -p nestrs-ws exception_filters
```
